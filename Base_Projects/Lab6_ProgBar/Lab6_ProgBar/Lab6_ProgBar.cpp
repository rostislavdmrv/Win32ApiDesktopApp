// Lab6_ProgBar.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "Lab6_ProgBar.h"
#include <commctrl.h>
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_LAB6_PROGBAR, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB6_PROGBAR));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB6_PROGBAR));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_LAB6_PROGBAR);
...
INT_PTR CALLBACK Dialog(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_TIMER:
					...
					if (SendDlgItemMessage(hDlg, IDC_PROGRESS1, PBM_GETPOS, 0, 0) == 1000){
						 ...
						 if (SendDlgItemMessage(hDlg, IDC_PROGRESS2, PBM_GETPOS, 0, 0) < 1000)
						 {
