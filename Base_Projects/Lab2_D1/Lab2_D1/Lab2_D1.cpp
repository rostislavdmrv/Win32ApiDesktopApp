// Lab2_D1.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB2_D1));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB2_D1));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_ABOUT:
			...
			break;
		case IDM_NA:
				DialogBox(hInst, MAKEINTRESOURCE(IDD_NEWDIALOG1), hWnd, FirstOurProg);
